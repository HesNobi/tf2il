...
from tf2rl.algos.airl_eql_rev import AIRL_EQL_REV
...
if __name__ == '__main__':
    ...
    parser = AIRL_EQL_REV.get_argument(parser)
    ...
    args.logdir += prep_log_tag(args, "airl-eql-rev", "sac", (units_ail, v), units, "debug_stage")
