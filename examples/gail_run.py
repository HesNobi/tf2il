...
if __name__ == '__main__':
    ...
    args.logdir += prep_log_tag(args, "gail", "sac", units_ail, units, "PC_STAGE")
    ...
    if args.absorbed_state_disable:
    ...
    expert_trajs = restore_latest_n_traj(args.expert_path_dir,
                                         ...
                                         max_steps=1000, env=env if args.absorbed_state_disable else None)
